...
export const userFormSchema = z.object({
	...
	email: z.string().email({ message: 'Formato non valido' }).min(1, 'Campo richiesto.'),
	password: z
		.string()
...
export const changePasswordSchema = z.object({
	...
	newPsw: z.string().min(8, 'Per motivi di sicurezza la password deve contenere 8 caratteri'),
