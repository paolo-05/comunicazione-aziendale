...
export default function ChangePassword(): JSX.Element {
	...
	const { register, handleSubmit, errors, isSubmitting, showPsw, handleShowPswChange, onSubmit } =
					...
					<section className='mt-36'>
						<div className='flex flex-col items-center justify-center px-6 py-8'>
							<div className='w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8'>
								...
								<form className='mt-4 space-y-4 lg:mt-5 md:space-y-5 md:w-96 xs:w-52' onSubmit={handleSubmit(onSubmit)}>
									<div>
									...
									<div>
										<label htmlFor='oldPsw' className='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>
										...
										/>
										{errors.oldPsw != null && (
											<p className='mt-2 text-sm text-red-600 dark:text-red-500'>{errors.oldPsw.message}</p>
										)}
									</div>

									<div>
										<label htmlFor='newPsw' className='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>
										...
										/>
										{errors.newPsw != null && (
											<p className='mt-2 text-sm text-red-600 dark:text-red-500'>{errors.newPsw.message}</p>
										)}
									</div>
									<div>
										<label
										...
										{errors.confirmPsw != null && (
											<p className='mt-2 text-sm text-red-600 dark:text-red-500'>{errors.confirmPsw.message}</p>
										)}
									</div>
