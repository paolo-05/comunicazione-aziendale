...
const colorClasses = ['red', 'orange', 'yellow', 'green', 'cyan', 'blue', 'purple', 'pink'];

export const ColorPicker = ({ change, initialColor }: ColorPickerProps): React.ReactElement => {
	const [selectedColor, setSelectedColor] = useState<string>(initialColor ?? 'red');
	...
	return (
		<div className='relative inline-block'>
			<span className='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>Colore (richiesto)</span>
