		...
		>
			<div className='bg-white p-8 rounded-md shadow-md max-w-md dark:bg-gray-800'>
				...
				<div className='flex justify-end'>
					...
					>
						<span className='relative text-base font-semibold text-white'>{confirmText}</span>
					</button>
					<button
						onClick={() => {
							handleModal(false);
					...
					>
						<span className='relative text-base font-semibold text-white'>{discardText}</span>
					</button>
				</div>
			</div>
		</div>
