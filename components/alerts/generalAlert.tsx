export const GeneralAlert = ({ show, message, onClose }: AlertProps) => {
  if (!show) {
    return null;
  }
  ...
  return (
    <div
      id="alert-general"
      className="flex items-center p-4 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-800"
      role="alert"
    >
      <svg
