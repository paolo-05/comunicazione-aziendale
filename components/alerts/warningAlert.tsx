...
export const WarningAlert = ({ show, message, onClose }: AlertProps) => {
  if (!show) {
    return null;
  }
  ...
  return (
    <div
      id="alert-warning"
      className="flex items-center p-4 mb-4 text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300"
      role="alert"
    >
      <svg
